...
def load_data(filename):
	...
	phrase_en_array =  df[selected[1]].apply(lambda x: x)
	#print(phrase_en_array)
	...
	for i in range(30):
		print(phrase_en_array[i])
	x = np.array([[vocabulary[word] for word in sentence] for sentence in x_raw])
	y = np.array(y_raw)
	return phrase_en_array, y, vocabulary, vocabulary_inv, df, labels
