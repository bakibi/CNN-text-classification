...
def train_cnn_rnn():
	...
	with open(trained_dir + 'words_index.json', 'w', encoding='utf8') as outfile:
	...
	with open(trained_dir + 'trained_parameters.json', 'w', encoding='utf8') as outfile:
